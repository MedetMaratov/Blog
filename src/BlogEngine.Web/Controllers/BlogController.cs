...
namespace BlogEngine.Web.Controllers
{
    ...
    public class BlogController : BaseController
    {
        ...
        {
            var query = new GetBlogsListBuNameQuery(blogName);
            var vm = await _mediator.Send(query);
            return Ok(vm);
        }
        ...
        {
            var query = new GetListOfBlogSubscribedToQuery(UserId);
            var vm = await _mediator.Send(query);
            return Ok(vm);
        }
        ...
        {
            var query = new GetBlogsListByCreatorQuery(creatorId);
            var vm = await _mediator.Send(query);
            return Ok(vm);
        }
        ...
        public async Task<ActionResult<BlogListVM>> GetByCategory([FromBody] GetBlogByCategoryDto categoriesDto)
        {
            var query = new GetBlogListByCategoryQuery(
                categoriesDto.IncludedCategories,
                categoriesDto.ExcludedCategories);
            var vm = await _mediator.Send(query);
            return Ok(vm);
        }
        ...
        {
            var query = new GetBlogDetailsQuery(id);
            var vm = await _mediator.Send(query);
            return Ok(vm);
        }
