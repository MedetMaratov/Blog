...
namespace BlogEngine.Web.Controllers
{
    public class PostController : BaseController
    {
        ...
        {
            var query = new GetPostsByBlogIdQuery(blogId);
            var vm = await _mediator.Send(query);
            return Ok(vm);
        }
        ...
        {
            var query = new GetSubscribedBlogPostsQuery(UserId);
            var vm = await _mediator.Send(query);
            return Ok(vm);
        }
        ...
        {
            var query = new GetPostsByTagsQuery(tagsDto.IncludedTags, tagsDto.ExcludedTags);
            var vm = await _mediator.Send(query);
            return Ok(vm);
        }
